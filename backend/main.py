...
import schedule
import time
# FCM removed - using Android local notifications only
...
# FCM Push Notifications removed - using Android local notifications only
# Reminders are scheduled locally on device via Capacitor LocalNotifications
...
async def startup_event():
    ...
    # Notification System
    print("🔔 [NOTIF] Notification system: Local notifications only (FCM disabled)")
    print("🔔 [NOTIF] Reminders are scheduled locally on Android devices")
...
# ========== PUSH TOKENS & NOTIFICATION SETTINGS REMOVED ==========
# FCM push notifications have been removed - using Android local notifications only
# The following endpoints have been removed:
#   - POST /api/push-tokens (register push token)
#   - DELETE /api/push-tokens/{token_id} (delete push token)
#   - GET /api/notification-settings (get platform preference)
#   - PUT /api/notification-settings (update platform preference)
