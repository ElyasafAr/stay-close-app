# Script to fix TypeScript errors and push to Git
# Usage: .\fix_typescript_errors.ps1
...
git add app/contacts/page.tsx components/AuthGuard.tsx
...
git commit -m "Fix: Resolve TypeScript errors in contacts page and AuthGuard"
if ($LASTEXITCODE -eq 0) {
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "✅ TypeScript errors fixed and pushed to GitHub!" -ForegroundColor Green
    Write-Host ""
