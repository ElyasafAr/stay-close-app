# Script to fix ESLint errors and push to Git
# Usage: .\fix_eslint_errors.ps1
...
git commit -m "Fix: Resolve ESLint errors in contacts page and AuthGuard"
if ($LASTEXITCODE -eq 0) {
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "✅ ESLint errors fixed and pushed to GitHub!" -ForegroundColor Green
    Write-Host ""
